...
var newitem='';
newitem+='<div class="row mb-3"> <div class="col-sm-10">';
newitem+=   '   <button type="button" style="height:31.59px;width:50px;background:#c5c5c5;">';
newitem+=     '<span class="sr-only">Close</span>';
newitem+=    ' <span aria-hidden="true">×</span>';
newitem+=  ' </button></p>';
...
<body>
  ...
  <h3 style="padding-left:30px;margin-top:20px;color:black">Название</h3>

  <form action="post.php" method="post">
    <p style="padding-left:30px;margin-top:20px;color:black">Название проекта <input style="width: 1400px;margin-left:75px;" type="text" name="name"></p>
    <div class="row mb-3">
    <label for="inputEmail3" class="col-sm-2 col-form-label"  style="color:black;">Название проекта</label>
    <div class="col-sm-10">
    ...
    <p style="padding-left:30px;margin-top:30px;color:black">Категории пользователей
    <div id="items">
     <div > <input style="width: 300px;margin-left:18px;" type="text" name="category[]">
      <button type="button" style="height:31.59px;width:50px;background:#c5c5c5;">
        <span class="sr-only">Close</span>
        <span aria-hidden="true">×</span>
      </button></p></div>
      <!-- <input type="button" onClick="AddItem();" ID="add" style="margin-left:247px;margin-top:-10px;height:31.59px;width:300px;background:#c5c5c5;border-radius: 2px;text-align: center;color:black;">+ Добавить -->
  </input>
  </div>

      <p style="padding-left:30px;margin-top:30px;color:black">Функции / характеристики
      <input style="width: 1345px;margin-left:18px;" type="text" name="functions[]"> <button type="button" style="height:31.59px;width:50px;background:#c5c5c5;">
        <span class="sr-only">Close</span>
        <span aria-hidden="true">×</span>
      </button></p>
      <div type="button" style="margin-left:252px;margin-top:-10px;height:31.59px;width:650px;background:#c5c5c5;border-radius: 2px;text-align: center;color:black;">+ Добавить
      </div>
  ...
  <div id="items">
  <div class="row mb-3">
    <label for="inputPassword3" class="col-sm-2 col-form-label">Категории</label>
    <div class="col-sm-10">
      <input type="password" class="form-control" id="inputPassword3"><br>
      <button type="button" class="btn btn-secondary" onclick="AddItem();" ID="add">Secondary</button>
    </div>
    </div>
  </div>
