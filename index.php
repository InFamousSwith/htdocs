...
<body>
  ...
  <div class="grid">
  <div type="button" class="cn" style="height:100px;width:150px;background:#c5c5c5;" onclick='location.href="//localhost/create.php";'>
...
if ($a != NULL) 
{
    for ($i = 0; $i < $id; $i++){
    ?>
    <div type="button" class="cn" style="height:100px;width:150px;background:#c5c5c5;" onclick='location.href="//localhost/redact.php?id=1";'>
    </div>
